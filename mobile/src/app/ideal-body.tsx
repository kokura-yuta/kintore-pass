...
const styles = StyleSheet.create({
  ...
  description: { marginTop: 9, color: '#99AAB4', fontSize: 14, lineHeight: 21 },
  ...
  divider: { height: 1, flex: 1, backgroundColor: '#203441' },
  dividerText: { color: '#72828D', fontSize: 12 },
  uploadPanel: {
    flexDirection: 'row',
    alignItems: 'center',
    padding: 15,
  ...
  uploadHint: { marginTop: 5, color: '#72828D', fontSize: 11 },
  uploadButton: { paddingHorizontal: 12, paddingVertical: 10 },
  uploadButtonText: { color: '#73E7FF', fontSize: 13, fontWeight: '700' },
  ...
  summaryLabel: { color: '#72828D', fontSize: 13 },
