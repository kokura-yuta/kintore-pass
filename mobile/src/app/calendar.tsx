...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: 'Yu Mincho', marginTop: 3, color: '#F4F6F3', fontSize: 27, fontWeight: '700' },
  calendarCard: { marginTop: 18, padding: 15, borderWidth: 1, borderColor: '#303030', borderRadius: 18, backgroundColor: '#151515' },
  monthHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  monthButton: { width: 38, height: 38, alignItems: 'center', justifyContent: 'center' },
  monthArrow: { color: '#FFF1B8', fontSize: 27 },
  monthTitle: { fontFamily: 'Yu Mincho', color: '#F4F6F3', fontSize: 15, fontWeight: '700' },
  weekRow: { flexDirection: 'row', marginTop: 12 },
  weekLabel: { width: '14.285%', color: '#697169', fontSize: 9, fontWeight: '600', textAlign: 'center' },
  ...
  selectedDay: { backgroundColor: '#F6D365' },
  dayText: { color: '#C9CECA', fontSize: 11, fontWeight: '600' },
  selectedDayText: { color: '#0A0A0A' },
  recordDot: { width: 5, height: 5, borderRadius: 3, backgroundColor: '#F6D365' },
  ...
  exerciseRow: { paddingVertical: 11, borderBottomWidth: 1, borderBottomColor: '#303030' },
