    ...
    <View style={styles.screen}>
      ...
      <Modal animationType="slide" onRequestClose={() => setDrawerVisible(false)} transparent visible={drawerVisible}>
        <View style={styles.modalBackdrop}><Pressable accessibilityLabel="履歴メニューを閉じる" onPress={() => setDrawerVisible(false)} style={styles.modalDismiss} /><SafeAreaView edges={['top', 'bottom']} style={styles.drawer}>
          <View style={styles.drawerHeader}><Text style={styles.drawerTitle}>チャット履歴</Text><Pressable accessibilityLabel="閉じる" onPress={() => setDrawerVisible(false)} style={styles.closeButton}><Text style={styles.closeText}>×</Text></Pressable></View>
...
const markdownStyles = StyleSheet.create({
  body: { width: '100%', maxWidth: '100%', color: '#E8EBE8', fontSize: 13, lineHeight: 22, flexShrink: 1 }, text: { color: '#E8EBE8', flexShrink: 1 }, paragraph: { marginTop: 0, marginBottom: 10, flexShrink: 1 },
  ...
  table: { width: '100%', maxWidth: '100%', marginVertical: 10, borderWidth: 1, borderColor: '#1E6076', overflow: 'hidden' }, thead: { backgroundColor: '#082733' }, th: { flex: 1, minWidth: 0, padding: 6, color: '#73E7FF', borderColor: '#1E6076', fontSize: 11 }, tr: { width: '100%', flexDirection: 'row', borderBottomWidth: 1, borderColor: '#19495A' }, td: { flex: 1, minWidth: 0, flexShrink: 1, padding: 6, color: '#E8EBE8', borderColor: '#19495A', fontSize: 11 },
...
const styles = StyleSheet.create({
  ...
  modalBackdrop: { flex: 1, flexDirection: 'row', backgroundColor: 'rgba(0,0,0,0.68)' }, modalDismiss: { flex: 1 }, drawer: { width: '88%', maxWidth: 380, backgroundColor: '#081018' }, drawerHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 14, borderBottomWidth: 1, borderBottomColor: '#142833' }, drawerTitle: { flex: 1, color: '#F4F6F3', fontSize: 20, fontWeight: '700' }, closeButton: { width: 48, height: 48, alignItems: 'center', justifyContent: 'center' }, closeText: { color: '#8798A3', fontSize: 26 }, drawerNewButton: { minHeight: 48, margin: 12, padding: 13, borderWidth: 1, borderColor: '#00D4FF', borderRadius: 13 }, drawerNewText: { color: '#73E7FF', fontSize: 12, fontWeight: '700', textAlign: 'center' }, chatList: { flexGrow: 1, paddingHorizontal: 12, paddingBottom: 20 }, emptyHistory: { padding: 16, color: '#8798A3', fontSize: 11, lineHeight: 18, textAlign: 'center' }, chatRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 6, borderRadius: 12, backgroundColor: '#0C1820' }, activeChatRow: { backgroundColor: '#082733' }, chatSelect: { flex: 1, minWidth: 0, padding: 12 }, chatTitle: { color: '#E8EBE8', fontSize: 12, fontWeight: '600' }, chatMeta: { marginTop: 4, color: '#7D8E99', fontSize: 9 }, deleteButton: { minWidth: 52, minHeight: 48, alignItems: 'center', justifyContent: 'center', padding: 9 }, deleteText: { color: '#FF8D98', fontSize: 10, fontWeight: '600' }, drawerNote: { padding: 15, color: '#657681', fontSize: 9, textAlign: 'center' },
});
