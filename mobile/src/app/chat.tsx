...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#0A0A0A' }, safeArea: { flex: 1 }, header: { minHeight: 66, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14, borderBottomWidth: 1, borderBottomColor: '#2C2924' }, menuButton: { width: 40, height: 40, alignItems: 'center', justifyContent: 'center' }, menuIcon: { color: '#F4F6F3', fontSize: 20 }, headerCopy: { flex: 1, marginHorizontal: 7 }, eyebrow: { color: '#FFF1B8', fontSize: 7, fontWeight: '700', letterSpacing: 1.2 }, title: { fontFamily: 'Yu Mincho', marginTop: 3, color: '#F4F6F3', fontSize: 15, fontWeight: '700' }, newButton: { width: 40, height: 40, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#3A3A3A', borderRadius: 12 }, newButtonText: { color: '#FFF1B8', fontSize: 20 },
  messages: { flexGrow: 1, paddingHorizontal: 14, paddingVertical: 17 }, welcome: { alignItems: 'center', paddingTop: 42 }, aiMark: { width: 54, height: 54, alignItems: 'center', justifyContent: 'center', borderRadius: 27, backgroundColor: '#F6D365' }, aiMarkText: { color: '#0A0A0A', fontSize: 14, fontWeight: '700' }, welcomeTitle: { fontFamily: 'Yu Mincho', marginTop: 17, color: '#F4F6F3', fontSize: 18, fontWeight: '700', textAlign: 'center' }, welcomeText: { marginTop: 8, maxWidth: 290, color: '#737B75', fontSize: 10, lineHeight: 16, textAlign: 'center' }, suggestions: { width: '100%', gap: 8, marginTop: 22 }, suggestion: { padding: 13, borderWidth: 1, borderColor: '#303030', borderRadius: 13, backgroundColor: '#151515' }, suggestionText: { color: '#C9CECA', fontSize: 11, fontWeight: '700' },
