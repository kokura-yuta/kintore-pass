...
const styles = StyleSheet.create({
  ...
  loadingArea: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 24 }, loadingTitle: { fontFamily: 'Yu Mincho', marginTop: 21, color: '#F4F6F3', fontSize: 22, fontWeight: '700' }, loadingText: { marginTop: 9, color: '#737B75', fontSize: 11, textAlign: 'center' }, completeEyebrow: { marginTop: 14, color: '#FFF1B8', fontSize: 9, fontWeight: '700', letterSpacing: 1.4 }, resultTitle: { fontFamily: 'Yu Mincho', marginTop: 7, color: '#F4F6F3', fontSize: 27, fontWeight: '700' }, resultCard: { marginTop: 13, padding: 17, borderWidth: 1, borderColor: '#303030', borderRadius: 17, backgroundColor: '#151515' }, resultNumber: { color: '#FFF1B8', fontSize: 9, fontWeight: '700' }, resultLabel: { marginTop: 6, color: '#F4F6F3', fontSize: 15, fontWeight: '700' }, resultText: { marginTop: 8, color: '#A5ADA7', fontSize: 11, lineHeight: 18 }, focusRow: { flexDirection: 'row', gap: 7, marginTop: 9 }, focusChip: { paddingHorizontal: 12, paddingVertical: 7, borderRadius: 16, backgroundColor: '#332B00' }, focusText: { color: '#FFF1B8', fontSize: 10, fontWeight: '700' }, previewNote: { marginTop: 13, color: '#59605A', fontSize: 9, lineHeight: 15, textAlign: 'center' },
});
