          ...
          <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.card}>
              ...
              <Pressable disabled={isSaving} onPress={addWeight} style={[styles.saveButton, isSaving && styles.disabledButton]}>
                {isSaving ? <ActivityIndicator color="#0B0D0C" /> : <Text style={styles.saveText}>体重を記録</Text>}
              </Pressable>
            </View>
...
const styles = StyleSheet.create({
  ...
  summaryRow: { flexDirection: 'row', gap: 10, marginTop: 18 }, summaryCard: { flex: 1, padding: 15, borderWidth: 1, borderColor: '#2C312D', borderRadius: 16, backgroundColor: '#151816' }, summaryLabel: { color: '#737B75', fontSize: 9, fontWeight: '800' }, summaryValue: { marginTop: 8, color: '#F4F6F3', fontSize: 23, fontWeight: '900' }, greenValue: { color: '#B6F24B' }, summaryUnit: { color: '#8E978F', fontSize: 10 },
  card: { marginTop: 13, padding: 16, borderWidth: 1, borderColor: '#2C312D', borderRadius: 17, backgroundColor: '#151816' }, cardHeading: { flexDirection: 'row', justifyContent: 'space-between' }, cardTitle: { color: '#F4F6F3', fontSize: 15, fontWeight: '900' }, cardHint: { color: '#737B75', fontSize: 9, fontWeight: '800' },
  chart: { height: 190, flexDirection: 'row', alignItems: 'flex-end', gap: 7, marginTop: 18, paddingTop: 14 }, barColumn: { flex: 1, alignItems: 'center' }, barValue: { marginBottom: 5, color: '#C9CECA', fontSize: 8, fontWeight: '800' }, bar: { width: '65%', maxWidth: 28, borderRadius: 7, backgroundColor: '#B6F24B' }, barDate: { marginTop: 6, color: '#697169', fontSize: 7, fontWeight: '700' }, emptyText: { marginTop: 15, color: '#737B75', fontSize: 10 },
  fieldLabel: { marginTop: 16, marginBottom: 7, color: '#A5ADA7', fontSize: 10, fontWeight: '800' }, textInput: { minHeight: 50, paddingHorizontal: 13, borderWidth: 1, borderColor: '#343A35', borderRadius: 12, backgroundColor: '#0B0D0C', color: '#F4F6F3', fontSize: 13 }, weightInputWrap: { minHeight: 50, flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#343A35', borderRadius: 12, backgroundColor: '#0B0D0C' }, weightInput: { flex: 1, paddingHorizontal: 13, color: '#F4F6F3', fontSize: 15, fontWeight: '800' }, inputUnit: { paddingRight: 13, color: '#737B75', fontSize: 10 },
  error: { marginTop: 9, color: '#FF7676', fontSize: 10 }, success: { marginTop: 9, color: '#B6F24B', fontSize: 10 }, saveButton: { minHeight: 51, alignItems: 'center', justifyContent: 'center', marginTop: 13, borderRadius: 13, backgroundColor: '#B6F24B' }, disabledButton: { opacity: 0.5 }, saveText: { color: '#0B0D0C', fontSize: 13, fontWeight: '900' },
  historyRow: { minHeight: 53, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: '#2C312D' }, historyDate: { color: '#A5ADA7', fontSize: 10, fontWeight: '700' }, historyRight: { flexDirection: 'row', alignItems: 'center', gap: 12 }, historyWeight: { color: '#F4F6F3', fontSize: 12, fontWeight: '900' }, historyDiff: { width: 45, color: '#737B75', fontSize: 8, textAlign: 'right' }, previewNote: { marginTop: 14, color: '#59605A', fontSize: 9, lineHeight: 15, textAlign: 'center' },
});
