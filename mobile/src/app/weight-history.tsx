...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: '#FFF1B8', fontSize: 8, fontWeight: '700', letterSpacing: 1.4 }, title: { fontFamily: 'Yu Mincho', marginTop: 3, color: '#F4F6F3', fontSize: 27, fontWeight: '700' },
  ...
  card: { marginTop: 13, padding: 16, borderWidth: 1, borderColor: '#303030', borderRadius: 17, backgroundColor: '#151515' }, cardHeading: { flexDirection: 'row', justifyContent: 'space-between' }, cardTitle: { fontFamily: 'Yu Mincho', color: '#F4F6F3', fontSize: 15, fontWeight: '700' }, cardHint: { color: '#737B75', fontSize: 9, fontWeight: '600' },
