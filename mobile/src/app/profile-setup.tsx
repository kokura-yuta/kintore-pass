...
const styles = StyleSheet.create({
  ...
  optionalBadge: { color: '#737B75', fontSize: 10, fontWeight: '800' },
  ...
  selectedOption: { borderColor: '#B6F24B', backgroundColor: '#B6F24B' },
  locationLabel: { color: '#F4F6F3', fontSize: 14, fontWeight: '900' },
  locationDescription: { marginTop: 6, color: '#737B75', fontSize: 10, lineHeight: 15 },
  selectedOptionText: { color: '#0B0D0C' },
  selectedDescription: { color: '#3C433D' },
  optionLabel: { marginTop: 20, color: '#C9CECA', fontSize: 12, fontWeight: '800' },
  ...
  chipText: { color: '#A5ADA7', fontSize: 12, fontWeight: '800' },
