...
const styles = StyleSheet.create({
  ...
  backButton: { width: 42, height: 42, alignItems: 'center', justifyContent: 'center', marginRight: 10, borderWidth: 1, borderColor: '#303030', borderRadius: 13 },
  ...
  accentValue: { color: '#FFF1B8' },
  summaryUnit: { color: '#8E978F', fontSize: 10 },
  ...
  timelineItem: { minWidth: 112, paddingHorizontal: 13, paddingVertical: 12, borderWidth: 1, borderColor: '#303030', borderRadius: 13, backgroundColor: '#151515' },
  selectedTimelineItem: { borderColor: '#F6D365', backgroundColor: '#F6D365' },
  timelineType: { color: '#737B75', fontSize: 8, fontWeight: '700', letterSpacing: 1 },
  timelineDate: { marginTop: 4, color: '#DDE1DD', fontSize: 10, fontWeight: '700' },
  selectedTimelineText: { color: '#0A0A0A' },
  detailCard: { marginTop: 13, padding: 17, borderWidth: 1, borderColor: '#303030', borderRadius: 18, backgroundColor: '#151515' },
  detailHeading: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  detailType: { color: '#FFF1B8', fontSize: 8, fontWeight: '700', letterSpacing: 1.2 },
  detailDate: { marginTop: 5, color: '#F4F6F3', fontSize: 16, fontWeight: '700' },
  metricPill: { paddingHorizontal: 10, paddingVertical: 8, borderRadius: 12, backgroundColor: '#272727' },
  metricValue: { color: '#DDE1DD', fontSize: 9, fontWeight: '700' },
  detailLabel: { marginTop: 20, color: '#737B75', fontSize: 9, fontWeight: '700' },
  summaryText: { marginTop: 7, color: '#E8EBE8', fontSize: 13, fontWeight: '700', lineHeight: 21 },
  bodyText: { marginTop: 7, color: '#A5ADA7', fontSize: 10, lineHeight: 17 },
  areaList: { gap: 9, marginTop: 9 },
  areaCard: { padding: 13, borderRadius: 13, backgroundColor: '#222222' },
  ...
  buttonArrow: { color: '#0A0A0A', fontSize: 27 },
  privacyNote: { marginTop: 13, color: '#59605A', fontSize: 9, lineHeight: 15, textAlign: 'center' },
});
