...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: '#B6F24B', fontSize: 9, fontWeight: '900', letterSpacing: 1.4 },
  title: { marginTop: 4, color: '#F4F6F3', fontSize: 25, fontWeight: '900' },
  closeButton: { paddingHorizontal: 13, paddingVertical: 9, borderWidth: 1, borderColor: '#343A35', borderRadius: 20 },
  closeText: { color: '#B6F24B', fontSize: 12, fontWeight: '800' },
  searchInput: { minHeight: 51, marginHorizontal: 20, marginTop: 19, paddingHorizontal: 15, borderWidth: 1, borderColor: '#343A35', borderRadius: 14, backgroundColor: '#151816', color: '#F4F6F3', fontSize: 14 },
  categoryRow: { gap: 8, paddingHorizontal: 20, paddingVertical: 15 },
  categoryChip: { paddingHorizontal: 15, paddingVertical: 9, borderWidth: 1, borderColor: '#343A35', borderRadius: 20 },
  selectedChip: { borderColor: '#B6F24B', backgroundColor: '#B6F24B' },
  categoryText: { color: '#9DA69F', fontSize: 11, fontWeight: '800' },
  selectedChipText: { color: '#0B0D0C' },
  list: { paddingHorizontal: 20, paddingBottom: 24 },
  exerciseRow: { minHeight: 67, flexDirection: 'row', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#272C28' },
  addedRow: { opacity: 0.45 },
  exerciseCopy: { flex: 1, paddingRight: 12 },
  exerciseName: { color: '#F4F6F3', fontSize: 13, fontWeight: '900' },
  exerciseMeta: { marginTop: 4, color: '#737B75', fontSize: 10 },
  addText: { color: '#B6F24B', fontSize: 11, fontWeight: '900' },
